...
from .compositor2 import WeightedCompositor
...
class MVRenderer(nn.Module):
    ...
    def render_meshes(self, meshes, color, azim, elev, dist, lights, background_color=(1.0, 1.0, 1.0), ):
        ...
        # meshes = meshes.extend(self.nb_views)
    ...
    def forward(self, meshes, points, azim=None, elev=None, dist=None, color=None, eyes_pos_list=None):
        """
        ...
        if not self.pc_rendering:
            color = self.rendering_color(None, points)
